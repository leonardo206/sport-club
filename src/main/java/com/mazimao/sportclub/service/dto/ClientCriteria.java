...
/**
 * Criteria class for the {@link com.mazimao.sportclub.domain.Client} entity. This class is used
 * in {@link com.mazimao.sportclub.web.rest.ClientResource} to receive all the possible filtering options from
...
public class ClientCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, status, userId, bookingsId);
    }
