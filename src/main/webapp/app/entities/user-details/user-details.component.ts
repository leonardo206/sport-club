...
export class UserDetailsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.userDetailsService
      ...
      .subscribe(
        (res: HttpResponse<IUserDetails[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInUserDetails(): void {
    this.eventSubscriber = this.eventManager.subscribe('userDetailsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IUserDetails[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
