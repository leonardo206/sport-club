...
import { ClubTypeComponent } from 'app/entities/club-type/club-type.component';
...
describe('Component Tests', () => {
  describe('ClubType Management Component', () => {
    let comp: ClubTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClubTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.clubTypes && comp.clubTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
