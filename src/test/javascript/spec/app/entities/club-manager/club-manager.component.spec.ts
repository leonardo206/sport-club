...
import { ClubManagerComponent } from 'app/entities/club-manager/club-manager.component';
...
describe('Component Tests', () => {
  describe('ClubManager Management Component', () => {
    let comp: ClubManagerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClubManagerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.clubManagers && comp.clubManagers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
